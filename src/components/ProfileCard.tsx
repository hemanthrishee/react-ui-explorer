      ...
      <div className="flex flex-wrap justify-center gap-4 mt-2 w-full">
        ...
        <div className="flex flex-col items-center">
          <div className="relative flex items-center justify-center mb-1">
            <span className="inline-flex items-center justify-center rounded-full bg-amber-100 border-4 border-amber-300 shadow text-5xl font-extrabold text-amber-600 h-28 w-28">
